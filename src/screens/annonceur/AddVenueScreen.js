 ...
 * - Après succès : navigation.navigate('AnnonceurRoot') au lieu de 'HomeTab'
 */
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      Alert.alert(
        ...
        [{ text: 'OK', onPress: () => navigation.navigate('AnnonceurRoot') }]
      );
    } catch (e) {
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <TextInput
          style={styles.input}
          placeholder="Ex: Le Loft des Arts"
          value={name}
        ...
        <TextInput
          style={styles.input}
          placeholder="Ex: 12 rue de la Paix, Paris 11e"
          value={address}
